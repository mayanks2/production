                    ...
                    if(!checkTimeZone && (merchant_customer_info.prefContactMethod === 0 || merchant_customer_info.prefContactMethod === 2)){
                      ...
                      if (merchant_customer_info.prefContactMethod === 0) {
                        ...
                        Promise.all([
                          ...
                          function (datas) {
                            console.log(datas);
                            console.log('tttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt')
                            return callback(null, responseMsg.RESPONSE200);
                          },
                          function (reject) {
                            console.log('yyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy' , reject)
                            return callback(null, responseMsg.RESPONSE200);
                          }
                        );
                      }else{
...
function updateMerchants(params) {
  return new Promise(async function (resolve, reject) {
    ...
    var trainingModeCheckStatusforUpdate = await trainingMode.checkTrainingMode(params.merchant_id)
    if (params.sms_sent !== undefined && !trainingModeCheckStatusforUpdate) {
      update_expression += ",sms_sent = sms_sent + " + params.sms_sent;
    }else if(trainingModeCheckStatusforUpdate && params.sms_sent !== undefined){
